...
<head>
    ...
    <title>Login - Wonderfull World</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="right-side">
            <h2>GO-Travel</h2>
            <p>Temukan destinasi wisata yang menakjubkan dan ciptakan kenangan tak terlupakan.</p>
            <button class="explore-btn">Eksplorasi Sekarang</button>
        </div>
    </div>
</body>
</html>